...
# read preprocessed data and test data
df = pd.read_csv("../data/preprocesed_data.csv")
result_df1 = pd.read_csv("../test_files/test_2023.csv")
result_df2 = pd.read_csv("../test_files/test_2023.csv")
result_df3 = pd.read_csv("../test_files/test_2023.csv")
result_df4 = pd.read_csv("../test_files/test_2023.csv")

# get full data and data for each junction seperately
